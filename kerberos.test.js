...
test.concurrent('no_kerberos_for_userAgents', async () => {
    const headers_and_html = await cas.login_using_kerberos(conf.test_services.p2, 'Kerberos', false)
    ...
    const headers_and_html_ = await cas.login_using_kerberos(conf.test_services.p2, no_krb_userAgent, false)
